...
def search(q: str = Query(min_length=1), db: Session = Depends(get_db)):
    ...
    search_defs = [
        ...
        ("asset", models.Asset, [models.Asset.name, models.Asset.type, models.Asset.role, models.Asset.hostname, models.Asset.ip_address, models.Asset.platform, models.Asset.environment, models.Asset.status, models.Asset.notes], "name", "updated_at", "notes", "status", "/system"),
        ...
        ("speed_test", models.SpeedTestResult, [models.SpeedTestResult.test_url, models.SpeedTestResult.method, models.SpeedTestResult.notes], "method", "tested_at", "notes", None, "/tools"),
